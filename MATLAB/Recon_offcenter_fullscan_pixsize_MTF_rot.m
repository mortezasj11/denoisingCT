% 对平板检测器短扫描，可指定重建图像像素，以及每个像素代表的实际大小
%
% 2011-11-03修改，在Reco1_offcenter_shortscan_Parker上得到，去掉参数MagFactor
% 2011-12-10修改，在Recon_offcenter_shortscan_Parker_pixsize上得到，针对全扫描数据进行重建
% 2013-12-21修改，对截止频率和滤波器进行修改
% h=10(line 23-24)(line 52)
function [RecoResult1]=Recon_offcenter_fullscan_pixsize_MTF_rot(Proj1,YMin,YMax,XMin,XMax,R,d,du,dv,pixelsize,Reconsize,Proj_Z,shortScan,dectectorshift)
 %R=158;  d=255-158;  du=2*0.055; dv= 2*0.055; pixelsize = 18.41/512 ;  Reconsize=512;  Proj_Z=0; shortScan=360; dectectorshift=1;
% input:
